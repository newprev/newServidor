    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataUltAlt', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 21, 20, 2, 477476))),
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 21, 20, 2, 477490))),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataUltAlt', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 21, 20, 2, 476753))),
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 21, 20, 2, 476768))),
            ],
            options={
                'db_table': 'ConvMon',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataUltAlt', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 21, 20, 2, 477147))),
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2022, 7, 28, 21, 20, 2, 477161))),
            ],
            options={
                'db_table': 'TetosPrev',
            },
