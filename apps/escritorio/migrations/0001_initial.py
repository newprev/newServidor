    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnpj', models.CharField(blank=True, max_length=14, null=True, unique=True, validators=[
                    utils.validators.validaApenasNumero, utils.validators.validaCNPJ])),
                ...
                ('qtdChaves', models.IntegerField(default=0, validators=[utils.validators.validaApenasNumero])),
                ('dataUltAlt', models.DateTimeField(default=datetime.datetime(2022, 8, 12, 22, 59, 2, 565963))),
                ('dataCadastro', models.DateTimeField(default=datetime.datetime(2022, 8, 12, 22, 59, 2, 565981))),
